...
int getopt(int argc, char *argv[], char *optstring) {
    static char *IndexPosition = nullptr; /* place inside current argv string */
    char *ArgString = nullptr;        /* where to start from next */
    ...
    if (ArgString == nullptr) {
        ...
        if (poptind >= argc) {
            ...
            IndexPosition = nullptr;  /* not in the middle of anything */
    ...
    } else if ((OptString = strchr(optstring, *ArgString)) == nullptr) {
        /*---------------------------------------------------------------------
